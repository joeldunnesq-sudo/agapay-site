...
- **Terms of Service (August 2, 2026): signed off.** The approved text is published at `public/terms.html` and preserved at `docs/legal/terms/terms-2026-08-02-final.html` under acceptance version `2026-08-02-final`. The earlier `2026-08-02` snapshot and hash remain unchanged for append-only acceptance history. The customer-facing attorney-review notice was removed after sign-off.
- **Privacy Policy (August 2, 2026): signed off.** The customer-facing attorney-review notice was removed after sign-off. The live policy was subsequently updated on August 11, 2026 to disclose limited Meta campaign measurement and account-deletion controls; its later update and effective dates remain visible on the public page.
...
- **Dispute process (resolved August 2026).** Mandatory arbitration and the class-action waiver were removed. Section 24 now uses a 30-day informal-resolution process followed by small-claims or appropriate state/federal court proceedings, and the August 2 Terms received final sign-off.
