...
The private Worker and its Workflow were deployed successfully (initial Worker version `f79d759b-50c3-46c3-ae49-b7d6f39c5fcf`). Its secret-name inventory was empty at verification. The main-site release and production parish activation remain pending the scoped secret and release checks; the internal Worker deployment did not create parish books or change Stripe.
