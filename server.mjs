...
const learnEnv = {
  ...
  AGAPAY_STRIPE_PRICE_GIVING_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_GIVING_MONTHLY,
  AGAPAY_STRIPE_PRICE_STEWARDSHIP_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_STEWARDSHIP_MONTHLY,
  AGAPAY_STRIPE_PRICE_PARISH_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_PARISH_MONTHLY,
