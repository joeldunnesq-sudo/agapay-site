...
const learnEnv = {
  ...
  AGAPAY_STRIPE_PRICE_STARTER_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_STARTER_MONTHLY,
  AGAPAY_STRIPE_PRICE_GIVING_79_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_GIVING_79_MONTHLY,
  AGAPAY_STRIPE_PRICE_PARISH_149_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_PARISH_149_MONTHLY,
  AGAPAY_STRIPE_PRICE_PARISH_179_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_PARISH_179_MONTHLY,
  AGAPAY_STRIPE_PRICE_PARISH_199_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_PARISH_199_MONTHLY,
  AGAPAY_STRIPE_PRICE_PARISH_209_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_PARISH_209_MONTHLY,
  AGAPAY_STRIPE_PRICE_ADDON_SACRAMENTS_9_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_ADDON_SACRAMENTS_9_MONTHLY,
  AGAPAY_STRIPE_PRICE_ADDON_COMMERCE_29_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_ADDON_COMMERCE_29_MONTHLY,
  AGAPAY_STRIPE_PRICE_ADDON_ACCOUNTING_129_MONTHLY: process.env.AGAPAY_STRIPE_PRICE_ADDON_ACCOUNTING_129_MONTHLY,
...
async function resolveStaticPath(urlPath) {
  ...
  } else if (/^\/give\/[^/]+\/?$/.test(pathname) && !path.extname(pathname)) {
