...
const checks = [
  ['Sacraments is owned by a registered feature module loaded before the dashboard core', dashboard.indexOf('/parish/feature-registry.js?v=20260831intelligence1') < dashboard.indexOf('/parish/features/sacraments.js?v=20260831intelligence1') && dashboard.indexOf('/parish/features/sacraments.js?v=20260831intelligence1') < dashboard.indexOf('/parish/app.js?') && sacramentsFeature.includes("ParishFeatureRegistry.register('sacraments'") && !coreApp.includes('let sacramentsState')],
