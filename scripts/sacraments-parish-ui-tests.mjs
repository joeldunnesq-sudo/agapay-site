...
const checks = [
  ...
  ['Pastoral follow-up is a server-scoped named-clergy workspace', dashboard.includes('data-sac-tab="follow-up"') && app.includes('pastoralAuthHeaders') && app.includes('Cover all clergy') && app.includes('Clergy tickler') && app.includes('Log contact') && app.includes('Schedule visit')],
