...
const checks = [
  ...
  ['Sacraments uses the shared visible feature switch', app.includes('class="sac-admin-switch agapay-feature-switch"') && app.includes('aria-label="Show Sacraments and Services in My AGAPAY"') && app.includes('Visible in My AGAPAY')],
