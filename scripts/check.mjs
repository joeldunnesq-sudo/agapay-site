...
assert.ok(siteChrome.includes('{ href: "/give/request-demo", label: "Request Demo", key: "demo" }'), "canonical static-site navigation should offer the parish demo landing page");
