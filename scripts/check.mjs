...
assert.ok(parishDashboardHtml.includes("sac-admin-shell") && parishDashboardHtml.includes("data-sac-tab=\"availability\"") && parishDashboardHtml.includes("data-sac-tab=\"blackouts\"") && parishDashboardHtml.includes("data-sac-tab=\"calendar\""), "parish Sacraments & Services dashboard should use the template-inspired tabbed workspace");
assert.ok(parishDashboardApp.includes("function setSacramentsDashboardTab") && parishDashboardApp.includes("function renderSacramentsCalendar") && parishDashboardApp.includes("function renderSacramentsBlackouts"), "parish Sacraments & Services dashboard should render requests, availability, blackouts, and calendar views");
