...
const backendSources = worker + core + stripeConnect + adminHandler + donorHandler + parishHandler + parishCommemorationsHandler + parishGivingCatalogHandler + parishSacramentsHandler + parishReconciliationHandler + parishNotifications + stripeFees + stripeHandler + parishInterestHandler;
const parishHandlers = parishHandler + parishCommemorationsHandler + parishGivingCatalogHandler + parishSacramentsHandler + parishReconciliationHandler;
