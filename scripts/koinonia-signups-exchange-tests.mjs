...
const sources = {
  ...
  parishApp: readParishDashboardSource(),
...
assert.match(sources.signupsPage, /myagapay-shell\.js\?v=20260911sessionresume1/, "Parish Signups must load the current unified app navigation shell");
