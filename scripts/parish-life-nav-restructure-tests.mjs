...
assert.match(parishTierMarkup, /Parish Signups[\s\S]*Serve the faithful/);
...
assert.match(landing, /\/donor\/app\.js\?v=20260904-controllers1/, "the Koinonia landing must load the current versioned calendar script");
