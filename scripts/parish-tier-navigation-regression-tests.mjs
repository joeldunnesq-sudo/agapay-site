...
assert.ok(dashboard.includes('/parish/style.css?v=20260803ministryedit1') && dashboard.includes('/parish/app.js?v=20260803ministryedit1'), "the loading-state assets must use the current cache versions");
