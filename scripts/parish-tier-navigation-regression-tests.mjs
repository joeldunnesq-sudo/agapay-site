...
assert.ok(dashboard.includes('/parish/style.css?v=20260801youtubechannel1') && dashboard.includes('/parish/app.js?v=20260801youtubechannel1'), "the loading-state assets must use the same fresh cache version");
