...
assert.ok(dashboard.includes('/parish/style.css?v=20260802appicon2') && dashboard.includes('/parish/app.js?v=20260802audiolinkrepair1'), "the loading-state assets must use the current cache versions");
