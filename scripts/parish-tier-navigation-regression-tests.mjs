...
assert.ok(dashboard.includes('/parish/style.css?v=20260801tierload1') && dashboard.includes('/parish/app.js?v=20260801tierload1'), "the loading-state assets must use the same fresh cache version");
