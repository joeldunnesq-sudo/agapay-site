...
assert.match(donorPage, /myagapay-shell\.js\?v=20260911sessionresume1/);
assert.match(parishLifePage, /myagapay-shell\.js\?v=20260911sessionresume1/);
...
assert.ok(adminPage.indexOf('/parish/feature-registry.js?v=') < adminPage.indexOf('/parish/features/library.js?v='));
assert.ok(adminPage.indexOf('/parish/features/library.js?v=') < adminPage.indexOf('/parish/app.js?'));
assert.match(parishLibraryFeature, /ParishFeatureRegistry\.register\('library'/);
assert.doesNotMatch(parishDashboardCore, /function loadParishLibraryAdmin/);
...
assert.match(parishDashboardScript, /const libraryIncluded = moduleIncluded\('library'\)/);
