...
let activation = { available: true, status: 'not_started', step: 'queued', completed: false },
  profiles = [],
  ticks = 0;
const shell = `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Accounting activation · Local preview</title><link rel="stylesheet" href="/parish/style.css"><link rel="stylesheet" href="/parish/redesign.css"><link rel="stylesheet" href="/parish/accounting-activation.css"><style>body{padding:30px;background:#f0f3f5;font-family:Arial,sans-serif}.preview-wrap{max-width:1100px;margin:auto}.preview-controls{display:flex;gap:15px;align-items:center;margin-bottom:20px;font-size:12px}.preview-controls a{color:#243d50}#accountingTierLabel,#accountingTierCopy,#accountingParishName{display:none}body:has(#mobile:checked) .preview-wrap{max-width:390px}</style></head><body><div class="preview-wrap"><nav class="preview-controls"><b>LOCAL TEST FIXTURE</b><a href="/">Welcome</a><a href="/?state=ready">Import</a><a href="/?state=failed">Paused</a><a href="/?state=preview">CSV preview</a><label><input id="mobile" type="checkbox">Narrow layout</label></nav><span id="accountingTierLabel"></span><span id="accountingTierCopy"></span><span id="accountingParishName"></span><div id="accountingPane"></div></div><script>
