...
const checks = [
  ...
  { name: "Give platform section", method: "GET", path: "/give#platform", ok: [200] },
  { name: "Give security section", method: "GET", path: "/give#security", ok: [200] },
  { name: "Give pricing section", method: "GET", path: "/give#pricing", ok: [200] },
