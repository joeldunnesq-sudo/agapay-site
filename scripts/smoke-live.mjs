...
const checks = [
  ...
  { name: "parish giving shell", method: "GET", path: "/giving/smoke-test", ok: [200] },
  { name: "find church giving page", method: "GET", path: "/give/find-church", ok: [200] },
  { name: "campaign share shell", method: "GET", path: "/giving/smoke-test/smoke-test-campaign", ok: [200] },
