...
const checks = [
  ...
  ['Commerce route resets to the overview before loading data', app.includes(`switchCommerceProduct('overview', false);`) && app.includes('function switchCommerceProduct(product, focus = true)')],
