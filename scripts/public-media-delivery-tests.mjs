...
import { parsePublicMediaPath, publicMediaBase, workerPublicMediaVerified } from '../src/portability/public-media.js';
...
assert.equal(workerPublicMediaVerified({ ...baseEnv, PARISH_R2_DEV_PUBLIC_ACCESS_DISABLED: '' }), false);
