(function () {
  ...
  const icons = {
    ...
    prayers: '<span aria-hidden="true" style="display:inline-grid;place-items:center;width:2.05rem;height:2.05rem;flex:0 0 auto;font-size:1.25rem;line-height:1">🙏</span>',
