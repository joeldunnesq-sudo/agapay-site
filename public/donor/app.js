...
function donorNavIcon(kind) {
  const icons = {
    ...
    profile: '<svg viewBox="0 0 28 28" aria-hidden="true"><circle cx="14" cy="14" r="3.5" fill="none" stroke="currentColor" stroke-width="2"/><path fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M14 4.5h0a1.8 1.8 0 0 0 1.8 1.8 1.8 1.8 0 0 0 1.1-.38l.06-.05a2.1 2.1 0 1 1 2.97 2.97l-.05.06a1.8 1.8 0 0 0-.38 1.1A1.8 1.8 0 0 0 21.3 11.8H21.5a2.1 2.1 0 0 1 0 4.2h-.1a1.8 1.8 0 0 0-1.8 1.8 1.8 1.8 0 0 0 .38 1.1l.05.06a2.1 2.1 0 1 1-2.97 2.97l-.06-.05a1.8 1.8 0 0 0-1.1-.38A1.8 1.8 0 0 0 14.2 23.2V23.5a2.1 2.1 0 0 1-4.2 0v-.1a1.8 1.8 0 0 0-1.8-1.8 1.8 1.8 0 0 0-1.1.38l-.06.05a2.1 2.1 0 1 1-2.97-2.97l.05-.06a1.8 1.8 0 0 0 .38-1.1A1.8 1.8 0 0 0 2.7 16.2H2.5a2.1 2.1 0 0 1 0-4.2h.1a1.8 1.8 0 0 0 1.8-1.8 1.8 1.8 0 0 0-.38-1.1l-.05-.06a2.1 2.1 0 1 1 2.97-2.97l.06.05a1.8 1.8 0 0 0 1.1.38A1.8 1.8 0 0 0 9.8 4.7V4.5a2.1 2.1 0 0 1 4.2 0z"/></svg>'
  };
