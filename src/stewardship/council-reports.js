...
export function accountingCouncilReport(parishName, period, monthly, yearToDate) {
  ...
  <nav class="toolbar"><a href="/parish/dashboard">← Back</a><div><button onclick="window.print()">Print</button> <button onclick="window.print()">Save as PDF</button></div></nav><main>
