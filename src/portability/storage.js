...
export const FILE_BINDINGS = ['CAMPAIGN_ASSETS','ANNOUNCEMENT_ASSETS','TEACHING_ASSETS','GROUP_MESSAGE_ASSETS','PARISH_LIBRARY_ASSETS','DIRECTORY_MEDIA','TAX_EXEMPTION_DOCS','NONPROFIT_PRICING_DOCS','GIVING_STATEMENTS','ACCOUNTING_ATTACHMENTS','SACRAMENT_DOCUMENTS'];
