...
export const FINANCIAL_TABLES = new Set(`donation_receipt_deliveries donor_offerings household_pledges manual_income_entries commerce_orders commerce_order_items commerce_weekly_reports giving_statement_jobs giving_statements settlement_profiles settlement_profile_modules stripe_payment_volume_records stripe_payment_volume_scans tax_exemptions tax_exemption_documents tax_exemption_notes tax_exemption_audit_log tax_exemption_stripe_syncs nonprofit_pricing_applications nonprofit_pricing_documents nonprofit_pricing_audit_log legal_acceptances audit_log stewardship_authoritative_financial_snapshots stewardship_financial_snapshot_revisions stewardship_financial_summaries stewardship_restricted_fund_snapshots stewardship_annual_meetings`.split(' '));
